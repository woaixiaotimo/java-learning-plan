...
4. 创建集群
    >启动六个redis  
    >./redis-cli -h 192.168.10.151 -p 7001 ./7001/redis.conf  
    >./redis-cli -h 192.168.10.151 -p 7002 ./7002/redis.conf    
    >./redis-cli -h 192.168.10.151 -p 7003 ./7003/redis.conf    
    >./redis-cli -h 192.168.10.151 -p 7004 ./7004/redis.conf    
    >./redis-cli -h 192.168.10.151 -p 7005 ./7005/redis.conf    
    >./redis-cli -h 192.168.10.151 -p 7006 ./7006/redis.conf    
    >创建集群  
